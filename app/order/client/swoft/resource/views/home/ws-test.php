        ...
        <div class="card-body">
          ...
          <div class="input-group mb-3">
            <input type="text" id="ws-addr"
                   ...
                   value="ws://<?php gethostbyname(gethostname()) ?>:18308/echo"
                   list="addr-list">
            ...
            <datalist id="addr-list">
              <option value="ws://<?php gethostbyname(gethostname()) ?>:18308/chat">
              <option value="ws://<?php gethostbyname(gethostname()) ?>:18308/chat">
              <option value="ws://<?php gethostbyname(gethostname()) ?>:18308/test">
